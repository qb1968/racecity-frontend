...
import { getCategories, getFilteredProducts7 } from "./apiCore";
...
const VintageAd = () => {
  ...
  const loadFilteredResults = (newFilters) => {
    ...
    getFilteredProducts7(skip, limit, newFilters).then((data) => {
      if (data.error) {
        setError(data.error);
      } else {
  ...
  const handleFilters = (filters, filterBy) => {
    // console.log("VintageAd", filters, filterBy);
    ...
    >
      <div id="nav-main">
        <ul className="group">
          ...
          <li className="main-li">
            <a className="main-a" href="/vintage">
              Vintage Advertising
            </a>
          </li>
        </ul>
      ...
      <div className="row">
        ...
        <div className="col-md-9">
          <h2 className="mb-2">Vintage Advertising</h2>
          <div className="row">
